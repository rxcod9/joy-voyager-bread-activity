...
namespace Joy\VoyagerBreadActivity\Models;
...
use Joy\VoyagerBreadActivity\Database\Factories\ActivityFactory;
...
class Activity extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Activity'));
    }
